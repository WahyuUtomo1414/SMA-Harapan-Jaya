        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-20 items-center">
            <div class="lg:col-span-7">
                ...
                <p class="text-gray-600 text-lg font-body leading-relaxed mb-12 font-light border-l border-gray-300 pl-6 max-w-2xl">
                    Kami berkomitmen pada standar transparansi dan akreditasi nasional untuk menjamin kualitas pendidikan terbaik bagi setiap generasi.
                </p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-2">
                    <div class="flex items-center justify-between py-6 border-b border-gray-100">
                        ...
                        <span class="font-headline font-bold text-xl text-on-surface">1994</span>
                    </div>
                    <div class="flex items-center justify-between py-6 border-b border-gray-100">
                        <span class="font-subhead font-bold text-gray-400 uppercase text-[10px] tracking-widest">Akreditasi</span>
                        <span class="font-headline font-bold text-xl text-primary italic">Peringkat A</span>
                    </div>
                    <div class="flex items-center justify-between py-6 border-b border-gray-100 md:border-b-0">
                        ...
                        <span class="font-headline font-bold text-xl text-on-surface">20104567</span>
                    </div>
                    <div class="flex items-center justify-between py-6">
                        <span class="font-subhead font-bold text-gray-400 uppercase text-[10px] tracking-widest">Status</span>
                        <span class="font-headline font-bold text-lg text-on-surface">SPK</span>
                    </div>
                </div>
            </div>
