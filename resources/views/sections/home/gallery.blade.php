...
<section class="py-32 bg-white border-b border-gray-100">
    <div class="max-w-7xl mx-auto px-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-1 md:gap-2">
            ...
            <div class="space-y-1 md:space-y-2">
                <div class="relative group overflow-hidden bg-gray-100 aspect-[3/4] cursor-pointer" onclick="openLightbox('{{ $galleryPhotos[0] }}')">
                ...
                <div class="relative group overflow-hidden bg-gray-100 aspect-square cursor-pointer" onclick="openLightbox('{{ $galleryPhotos[1] }}')">
            ...
            <div class="space-y-1 md:space-y-2 pt-0 md:pt-16">
                <div class="relative group overflow-hidden bg-gray-100 aspect-square cursor-pointer" onclick="openLightbox('{{ $galleryPhotos[2] }}')">
                    <img alt="Galeri Sekolah 3"
                        class="w-full h-full object-cover filter grayscale contrast-125 transition-all duration-700 group-hover:grayscale-0 group-hover:scale-105"
                        src="{{ $galleryPhotos[2] }}" />
                </div>
                <div class="relative group overflow-hidden bg-gray-100 aspect-[3/4] cursor-pointer" onclick="openLightbox('{{ $galleryPhotos[3] }}')">
            ...
            <div class="space-y-1 md:space-y-2">
                <div class="relative group overflow-hidden bg-gray-100 aspect-[3/4] cursor-pointer" onclick="openLightbox('{{ $galleryPhotos[4] }}')">
                    <img alt="Galeri Sekolah 5"
                        class="w-full h-full object-cover filter grayscale contrast-125 transition-all duration-700 group-hover:grayscale-0 group-hover:scale-105"
                        src="{{ $galleryPhotos[4] }}" />
                </div>
                <div class="relative group overflow-hidden bg-gray-100 aspect-square cursor-pointer" onclick="openLightbox('{{ $galleryPhotos[5] }}')">
            ...
            <div class="space-y-1 md:space-y-2 pt-0 md:pt-16">
                <div class="relative group overflow-hidden bg-gray-100 aspect-square cursor-pointer" onclick="openLightbox('{{ $galleryPhotos[6] }}')">
                    <img alt="Galeri Sekolah 7"
                        class="w-full h-full object-cover filter grayscale contrast-125 transition-all duration-700 group-hover:grayscale-0 group-hover:scale-105"
                        src="{{ $galleryPhotos[6] }}" />
                </div>
                <div class="relative group overflow-hidden bg-gray-100 aspect-[3/4] cursor-pointer" onclick="openLightbox('{{ $galleryPhotos[7] }}')">
    ...
    <!-- Lightbox Modal -->
    <div id="gallery-lightbox" class="fixed inset-0 z-[100] hidden flex items-center justify-center bg-black/90 p-4 md:p-8" onclick="closeLightbox()">
        <button class="absolute top-6 right-6 text-white hover:text-primary transition-colors duration-300" onclick="closeLightbox()">
            <span class="material-symbols-outlined !text-4xl">close</span>
        </button>
        <div class="relative max-w-5xl w-full h-full flex items-center justify-center" onclick="event.stopPropagation()">
            <img id="lightbox-image" src="" alt="Gallery Image Large" class="max-w-full max-h-full object-contain shadow-2xl transition-transform duration-500 scale-95" />
        </div>
    </div>
