<x-mail::message>
    ...
    **Kepada Calon Siswa:** Kami berterima kasih atas partisipasi Anda dalam proses seleksi pendaftaran siswa baru di
    {{ $sekolah?->nama ?? 'sekolah kami' }}.

    Setelah meninjau seluruh dokumen pendaftaran dan mempertimbangkan kuota yang tersedia, kami menginformasikan bahwa
    pendaftaran Anda saat ini **BELUM DAPAT DITERIMA** untuk tahun ajaran
    {{ now()->format('Y') }}/{{ now()->addYear()->format('Y') }}.

    Keputusan ini bersifat final dan didasarkan pada peringkat seleksi akademik serta keterbatasan daya tampung kelas.
    Kami menghargai usaha yang telah Anda tunjukkan dan mendoakan kesuksesan untuk kelanjutan studi Anda di institusi
    pendidikan lainnya.
    ...
    <div
        style="margin-top: 30px; background-color: #f9fafb; border: 1px solid #e5e7eb; padding: 15px; font-size: 11px; color: #999;">
        <strong>Academic Records Office:</strong><br>
        Your application record will be stored in our database for the current academic cycle and will be purged
        thereafter.
    </div>
</x-mail::message>
