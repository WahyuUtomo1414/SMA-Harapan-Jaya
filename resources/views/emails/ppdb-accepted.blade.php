<x-mail::message>
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td style="padding-left: 20px; vertical-align: middle;">
                    <h1 style="margin: 0; font-family: Arial, sans-serif; font-size: 20px; color: #111; text-transform: uppercase; letter-spacing: 1px;">
    ...
    <div style="text-align: center; margin-bottom: 30px;">
        <h2 style="font-family: Arial, sans-serif; font-size: 18px; font-weight: bold; text-transform: uppercase; letter-spacing: 1px; margin: 0;">
    ...
    Berdasarkan hasil seleksi administrasi dan penilaian panitia PPDB {{ $sekolah?->nama ?? 'sekolah' }}, kami menyampaikan bahwa calon peserta didik atas nama **{{ $record->nama_lengkap }}** dinyatakan **DITERIMA** sebagai peserta didik baru untuk tahun ajaran {{ now()->format('Y') }}/{{ now()->addYear()->format('Y') }}.

    Berikut ketentuan daftar ulang yang perlu diperhatikan:

    * **Verifikasi dokumen:** Membawa dokumen asli seperti Akta Kelahiran, Kartu Keluarga, Ijazah atau Surat Keterangan Lulus.
    ...
    * **Batas waktu:** Paling lambat 7 hari setelah surel ini diterima.
    ...
    <div style="border: 1px solid #111; padding: 12px; margin: 25px 0; text-align: center; font-family: Arial, sans-serif; font-weight: bold;">
        NOMOR REGISTRASI: PPDB-{{ $record->id }}-{{ now()->format('Y') }}
    </div>

    Seluruh data dan dokumen yang diserahkan wajib sesuai dengan kondisi sebenarnya. Apabila di kemudian hari ditemukan ketidaksesuaian data, sekolah berhak meninjau kembali status penerimaan.
    ...
    <div style="margin-top: 30px; background-color: #fdf9e9; border: 1px solid #e5e7eb; padding: 15px; font-size: 11px;">
