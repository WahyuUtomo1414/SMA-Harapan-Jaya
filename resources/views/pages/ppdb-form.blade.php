...
@section('content')
    ...
    <section class="relative border-b border-gray-200 bg-white">
        ...
        <div class="max-w-4xl mx-auto px-6 py-16 text-center">
            <span
                class="inline-block border border-gray-300 text-gray-500 px-4 py-1.5 text-[10px] font-subhead font-bold tracking-[0.25em] uppercase mb-6">
                PPDB TA 2025/2026
            </span>
            ...
            <p class="text-gray-500 font-body text-base leading-relaxed max-w-xl mx-auto">
                Lengkapi formulir di bawah ini dengan data yang benar dan valid. Pastikan dokumen yang diunggah terbaca
                dengan jelas.
            </p>
        </div>
    </section>
        ...
        <form method="POST" action="{{ route('ppdb.form.store') }}" enctype="multipart/form-data" class="space-y-10">
            ...
            <div class="border border-gray-200 bg-white">
                <div class="bg-primary px-8 py-4">
                    <h2 class="text-white font-headline text-lg font-medium tracking-tight">A. Identitas Calon Peserta Didik
                    </h2>
                </div>
                <div class="p-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="nik"
                            class="block text-xs font-subhead font-bold uppercase tracking-widest text-gray-600 mb-2">NIK
                            <span class="text-red-500">*</span></label>
                        <input id="nik" name="nik" type="number" maxlength="16" value="{{ old('nik') }}"
                    ...
                    <div>
                        <label for="nisn"
                            class="block text-xs font-subhead font-bold uppercase tracking-widest text-gray-600 mb-2">NISN</label>
                        <input id="nisn" name="nisn" type="number" value="{{ old('nisn') }}"
                    ...
                    <div class="md:col-span-2">
                        <label for="nama_lengkap"
                            class="block text-xs font-subhead font-bold uppercase tracking-widest text-gray-600 mb-2">Nama
                    ...
                    <div>
                        <label for="tempat_lahir"
                            class="block text-xs font-subhead font-bold uppercase tracking-widest text-gray-600 mb-2">Tempat
                    ...
                    <div>
                        <label for="tanggal_lahir"
                            class="block text-xs font-subhead font-bold uppercase tracking-widest text-gray-600 mb-2">Tanggal
                            Lahir <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label for="no_hp"
                            class="block text-xs font-subhead font-bold uppercase tracking-widest text-gray-600 mb-2">No. HP
                    ...
                    <div>
                        <label for="asal_sekolah"
                            class="block text-xs font-subhead font-bold uppercase tracking-widest text-gray-600 mb-2">Asal
                    ...
                    <div>
                        <label
                            class="block text-xs font-subhead font-bold uppercase tracking-widest text-gray-600 mb-2">Jenis
                    ...
                    <div>
                        <label for="email"
                            class="block text-xs font-subhead font-bold uppercase tracking-widest text-gray-600 mb-2">Email
                            <span class="text-red-500">*</span></label>
                    ...
                    <div class="md:col-span-2">
                        <label for="alamat"
                            class="block text-xs font-subhead font-bold uppercase tracking-widest text-gray-600 mb-2">Alamat
                            Lengkap <span class="text-red-500">*</span></label>
                        <textarea id="alamat" name="alamat" rows="3" placeholder="Alamat lengkap sesuai KTP/KK"
                    ...
                    <div>
                        <label for="jurusan"
                            class="block text-xs font-subhead font-bold uppercase tracking-widest text-gray-600 mb-2">Pilih
                            Jurusan <span class="text-red-500">*</span></label>
                        <select id="jurusan" name="jurusan"
                            ...
                            <option value="IPA" {{ old('jurusan') === 'IPA' ? 'selected' : '' }}>IPA — Ilmu Pengetahuan
                                Alam</option>
                            <option value="IPS" {{ old('jurusan') === 'IPS' ? 'selected' : '' }}>IPS — Ilmu Pengetahuan
                                Sosial</option>
                        </select>
                        @error('jurusan')
                            <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                    ...
                    <div>
                        <label for="agama"
                            class="block text-xs font-subhead font-bold uppercase tracking-widest text-gray-600 mb-2">Agama
                            <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label for="anak_ke"
                            class="block text-xs font-subhead font-bold uppercase tracking-widest text-gray-600 mb-2">Anak
                        ...
                        <select id="anak_ke" name="anak_ke"
                            ...
                            @for ($i = 1; $i <= 15; $i++)
                                <option value="{{ $i }}" {{ old('anak_ke') == $i ? 'selected' : '' }}>
                                    {{ $i }}</option>
                            @endfor
                        </select>
                    </div>
                    ...
                    <div>
                        <label for="dari"
                            class="block text-xs font-subhead font-bold uppercase tracking-widest text-gray-600 mb-2">Dari
                            (Bersaudara) <span class="text-red-500">*</span></label>
                        <select id="dari" name="dari"
                            class="w-full border border-gray-300 px-4 py-3 text-sm font-body text-on-surface focus:outline-none focus:border-primary transition bg-white appearance-none">
                            <option value="" disabled {{ !old('dari') ? 'selected' : '' }}>Pilih</option>
                            @for ($i = 1; $i <= 15; $i++)
                                <option value="{{ $i }}" {{ old('dari') == $i ? 'selected' : '' }}>
                                    {{ $i }}</option>
                            @endfor
                        </select>
                    </div>
                    ...
                    <div>
                        <label for="tinggi_badan"
                            class="block text-xs font-subhead font-bold uppercase tracking-widest text-gray-600 mb-2">Tinggi
                            Badan (cm)</label>
                        <input id="tinggi_badan" name="tinggi_badan" type="number" min="1"
                            value="{{ old('tinggi_badan') }}" placeholder="Contoh: 165"
                            class="w-full border border-gray-300 px-4 py-3 text-sm font-body text-on-surface placeholder-gray-400 focus:outline-none focus:border-primary transition">
                    </div>
                    ...
                    <div>
                        <label for="berat_badan"
                            class="block text-xs font-subhead font-bold uppercase tracking-widest text-gray-600 mb-2">Berat
                            Badan (kg)</label>
                        <input id="berat_badan" name="berat_badan" type="number" min="1"
                            value="{{ old('berat_badan') }}" placeholder="Contoh: 55"
                            class="w-full border border-gray-300 px-4 py-3 text-sm font-body text-on-surface placeholder-gray-400 focus:outline-none focus:border-primary transition">
                    </div>
                ...
                <div class="p-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="pekerjaan_ayah"
                            class="block text-xs font-subhead font-bold uppercase tracking-widest text-gray-600 mb-2">Pekerjaan
                            Ayah</label>
                        <input id="pekerjaan_ayah" name="pekerjaan_ayah" type="text"
                            value="{{ old('pekerjaan_ayah') }}" placeholder="Contoh: Wiraswasta"
                            class="w-full border border-gray-300 px-4 py-3 text-sm font-body text-on-surface placeholder-gray-400 focus:outline-none focus:border-primary transition">
                    </div>
                    ...
                    <div>
                        ...
                        <input id="pekerjaan_ibu" name="pekerjaan_ibu" type="text"
                            value="{{ old('pekerjaan_ibu') }}" placeholder="Contoh: Ibu Rumah Tangga"
                            class="w-full border border-gray-300 px-4 py-3 text-sm font-body text-on-surface placeholder-gray-400 focus:outline-none focus:border-primary transition">
                    </div>

                    <div>
                        <label for="no_hp_ortu"
                            class="block text-xs font-subhead font-bold uppercase tracking-widest text-gray-600 mb-2">No.
                            HP Orang Tua / Wali</label>
                        <input id="no_hp_ortu" name="no_hp_ortu" type="number" value="{{ old('no_hp_ortu') }}"
                            placeholder="08xxxxxxxxxx"
                            class="w-full border border-gray-300 px-4 py-3 text-sm font-body text-on-surface placeholder-gray-400 focus:outline-none focus:border-primary transition">
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="alamat_ortu" name="alamat_ortu" rows="3" placeholder="Alamat lengkap orang tua / wali"
            ...
            <div class="border border-gray-200 bg-white">
                ...
                <div class="px-8 pt-3 pb-2">
                    <p class="text-xs text-gray-500 font-body">Format yang diterima: PDF, JPG, PNG. Ukuran maksimal
                        <strong>2 MB</strong> per file.</p>
                </div>
                <div class="p-8 pt-4 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    @foreach ($dokumen as $dok)
                        <div>
                            <label for="{{ $dok['id'] }}"
                                class="block text-xs font-subhead font-bold uppercase tracking-widest text-gray-600 mb-2">
                                {{ $dok['label'] }} @if ($dok['required'])
                            ...
                            <label for="{{ $dok['id'] }}"
                                ...
                                <span
                                    class="shrink-0 w-10 h-10 flex items-center justify-center border border-gray-300 group-hover:border-primary bg-gray-50 transition">
                                    <svg class="w-5 h-5 text-gray-400 group-hover:text-primary transition" fill="none"
                                ...
                                <div class="flex-1 min-w-0">
                                    <p id="{{ $dok['id'] }}_name" class="text-sm font-body text-gray-500 truncate">
                                        Tidak ada file dipilih</p>
                                    <p class="text-[11px] text-gray-400 mt-0.5">
                                        {{ $dok['image_only'] ? 'JPG, PNG' : 'PDF, JPG, PNG' }} · maks 2 MB</p>
                                </div>
