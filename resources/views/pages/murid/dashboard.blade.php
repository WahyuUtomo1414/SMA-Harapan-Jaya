...
<div class="space-y-8">
    ...
    <div class="bg-white border border-gray-200 p-8 relative overflow-hidden">
        ...
        <div class="relative z-10">
            ...
            <p class="text-gray-500 font-body max-w-2xl leading-relaxed">
                Pantau perkembangan akademik, jadwal pelajaran, dan hasil belajar Anda di sini. Semangat belajar!
            </p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-white border border-gray-200 p-6 flex items-center gap-6">
            ...
            <div>
                <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Jadwal Hari Ini</p>
        ...
        <div class="bg-white border border-gray-200 p-6 flex items-center gap-6">
            ...
            <div>
                <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">IPK Terakhir</p>
                <p class="text-2xl font-headline font-bold text-on-surface">--</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white border border-gray-200 overflow-hidden">
        <div class="px-8 py-5 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
            <h3 class="font-headline font-bold text-on-surface italic">Informasi Siswa</h3>
        ...
        <div class="p-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-y-8 gap-x-12">
                ...
                <div>
                    ...
                    <p class="text-on-surface font-headline font-bold text-lg border-b border-gray-100 pb-2">Murid Siswa</p>
                </div>
                <div>
